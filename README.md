...
[![Build Status](https://travis-ci.org/JinWuZhao/go-binance.svg?branch=master)](https://travis-ci.org/JinWuZhao/go-binance)
[![GoDoc](https://godoc.org/github.com/JinWuZhao/go-binance?status.svg)](https://godoc.org/github.com/JinWuZhao/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/JinWuZhao/go-binance)](https://goreportcard.com/report/github.com/JinWuZhao/go-binance)
[![codecov](https://codecov.io/gh/JinWuZhao/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/JinWuZhao/go-binance)
...
```shell
go get github.com/JinWuZhao/go-binance
```
...
```golang
import (
    "github.com/JinWuZhao/go-binance"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/JinWuZhao/go-binance) for full references.
